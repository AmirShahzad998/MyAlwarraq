<div>
                            ...
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" wire:model="invoice_no"
                                        class="form-control @error('invoice_no') is-invalid @enderror" id="invoice_no" value="{{ old('invoice_no') }}" placeholder="Invoice No">
                                    @error('invoice_no')
        ...
        <div class="col-lg-8 col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between shadow mb-4">
                    ...
                    <button type="button" class="btn btn-sm btn-primary" wire:click="add_material" {{$enable_material ? '' : 'disabled'}}><i class="bx bx-plus"></i></button>
                </div>
                <div class="card-body">
    ...
    <div wire:ignore.self class="modal fade bd-example-modal-lg" id="material_modal" tabindex="-1"  role="dialog" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <select wire:model="material_id" id="material_id" class="form-control select" style="width: 100%;">
                                        <option value=""></option>
                                        @if ($materials)
