                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <select wire:model="material_type_id" class="form-control" id="material_type_id" >
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select wire:model="batch_no" class="form-control" id="batch_no" >
                                        <option value="">Select an option</option>
                                        @if ($batches)
                            ...
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="date" wire:model="material_date"
                                    class="form-control bg-white @error('material_date') is-invalid @enderror" id="material_date"
        ...
        <div class="col-lg-8 col-12">
            <div class="card">
                    ...
                    <table class="table table-bordered mt-5">
                        ...
                        <tbody>
                            ...
                            @php
                                $sr_no = 1;
                            @endphp
                            @forelse ($actual_materials as $item)
                                <tr>
                                    <td>{{$sr_no++}}</td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="number" step="any" class="form-control" id="total_actual_cost"
                                        wire:model="total_actual_cost" value="0" readonly>
                ...
                <div class="card-footer">
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary" wire:click="store">Save Actual Cost</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $("#batch_no").on('change', function(event) {
        let value = $(this).val();
        let element = event.target.id;
        @this.set(element, value);
    });
